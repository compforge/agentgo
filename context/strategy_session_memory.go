...
func (s *SessionMemoryStrategy) Apply(ctx context.Context, _ []agentgo.AgentMessage, view []agentgo.AgentMessage, budget Budget) ([]agentgo.AgentMessage, StrategyResult, error) {
