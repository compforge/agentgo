...
// AfterTurnHook runs after a normal turn has been committed and the loop has
// decided whether and how to advance. State is therefore a complete
// turn-boundary checkpoint. Returning an error stops the run.
