...
// Errors produced by agentgo fall into two layers:
//
...
// Both the agentgo wrapper (*ContextOverflowError) and adapter-classified
...
// which covers both the agentgo wrapper and adapter-classified errors.
