...
// rather than agentgo/team to avoid a task↔team import cycle: team needs
...
type Entry struct {
	...
	// channel for delivery (see agentgo/team). This field stays subagent-only.
...
func (n Notification) ToAgentMessage() agentgo.AgentMessage {
	...
	return agentgo.UserMsg(b.String())
}
